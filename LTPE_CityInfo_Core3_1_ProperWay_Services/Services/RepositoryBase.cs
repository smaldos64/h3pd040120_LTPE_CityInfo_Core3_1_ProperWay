...
using LTPE_CityInfo_Core3_1_ProperWay_Services.Interfaces;
using LTPE_CityInfo_Core3._1_ProperWay_Data.Context;

namespace LTPE_CityInfo_Core3_1_ProperWay_Services.Services
{
